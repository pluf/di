...
This is an opinionated guide on how to use DI and dependency injection for the best.
...
- if you use Pluf DI's annotations (PHP8 attribute) to mark the dependency to be injected, your class is dependent on the container (see the 2nd rule above)
...
of the constructor in the configuration. DI will guess which object it needs to inject by checking
...
$container[Psr\Log\LoggerInterface::class] = Conatiner::factory(function () {
